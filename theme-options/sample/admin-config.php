...
$args = array(
	...
	'menu_title'                => esc_html__( 'Ecom Options', 'ecom-theme' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Ecom Options', 'ecom-theme' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//devs.redux.io/',
	'title' => __( 'Documentation', 'ecom-theme' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'ecom-theme' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-extensions',
	'href'  => 'redux.io/extensions',
	'title' => __( 'Extensions', 'ecom-theme' ),
);
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'ecom-theme' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'ecom-theme' ) . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'ecom-theme' ) . '</p>';
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'ecom-theme' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'ecom-theme' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'ecom-theme' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'ecom-theme' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'ecom-theme' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Basic Fields', 'ecom-theme' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'These are really basic fields!', 'ecom-theme' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Editors', 'ecom-theme' ),
		'id'               => 'editor',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Color Selection', 'ecom-theme' ),
		'id'    => 'color',
		'icon'  => 'el el-brush',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Design Fields', 'ecom-theme' ),
		'id'    => 'design',
		'icon'  => 'el el-wrench',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Media Uploads', 'ecom-theme' ),
		'id'    => 'media',
		'icon'  => 'el el-picture',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Presentation Fields', 'ecom-theme' ),
		'id'    => 'presentation',
		'icon'  => 'el el-screen',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Switch / Button Set', 'ecom-theme' ),
		'id'    => 'switch_buttonset',
		'icon'  => 'el el-cogs',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Select Fields', 'ecom-theme' ),
		'id'    => 'select',
		'icon'  => 'el el-list-alt',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Slider / Spinner', 'ecom-theme' ),
		'id'    => 'slider_spinner',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Additional Types', 'ecom-theme' ),
		'id'    => 'additional',
		'icon'  => 'el el-magic',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Advanced Features', 'ecom-theme' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Disabling', 'ecom-theme' ),
		'icon'  => 'el el-lock',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Redux Extensions', 'ecom-theme' ),
		'id'    => 'redux-extensions',
		'icon'  => 'el el-redux',
		'class' => 'pro_highlight',
		'desc'  => esc_html__( 'For full documentation on this field, visit: ', 'ecom-theme' ) . '<a href="https://devs.redux.io/core-extensions/" target="_blank">https://devs.redux.io/core-extensions/</a>',
	)
);
...
if ( file_exists( $dir . '/../README.md' ) ) {
	$section = array(
		'icon'   => 'el el-list-alt',
		'title'  => esc_html__( 'Documentation', 'ecom-theme' ),
		'fields' => array(
			array(
...
Redux::set_section(
	...
	array(
		'icon'            => 'el el-list-alt',
		'title'           => esc_html__( 'Customizer Only', 'ecom-theme' ),
		'desc'            => '<p class="description">' . esc_html__( 'This Section should be visible only in Customizer', 'ecom-theme' ) . '</p>',
		'customizer_only' => true,
		'fields'          => array(
			array(
				'id'              => 'opt-customizer-only',
				'type'            => 'select',
				'title'           => esc_html__( 'Customizer Only Option', 'ecom-theme' ),
				'subtitle'        => esc_html__( 'The subtitle is NOT visible in customizer', 'ecom-theme' ),
				'desc'            => esc_html__( 'The field desc is NOT visible in customizer.', 'ecom-theme' ),
				'customizer_only' => true,
				'options'         => array(
					'1' => esc_html__( 'Opt 1', 'ecom-theme' ),
					'2' => esc_html__( 'Opt 2', 'ecom-theme' ),
					'3' => esc_html__( 'Opt 3', 'ecom-theme' ),
				),
				'default'         => '2',
			),
		),
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( array $sections ): array {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', 'ecom-theme' ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'ecom-theme' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( array $defaults ): array {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'ecom-theme' );
